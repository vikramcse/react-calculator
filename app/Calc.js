      ...
      <div className="section">
        <div className="row">
          ...
          <div className="center controls">
            ...
            <button
              value="+"
              className="btn waves-effect grey waves-light operator"
              disabled={this.state.disabled}>+</button><br />
            ...
            <button
              value="*"
              className="btn waves-effect grey waves-light operator"
              disabled={this.state.disabled}>x</button><br />
            <button value="0" className="btn waves-effect waves-light number">0</button>
            <button value="." className="btn waves-effect waves-light number dot">.</button>
            <button
              value="="
              className="btn waves-effect grey waves-light equal"
              disabled={this.state.disabled}>=</button>
            <button
              value="/"
              className="btn waves-effect grey waves-light operator"
              disabled={this.state.disabled}>/</button><br />
